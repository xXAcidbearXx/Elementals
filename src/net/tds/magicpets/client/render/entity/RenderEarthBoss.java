...
public class RenderEarthBoss extends RenderLiving {
	...
	public void renderBoss(EntityEarthBoss turtle, double par2, double par3, double par4, float par5, float par6) {
	...
	public void doRender(Entity entity, double par2, double par3, double par4, float par5, float par6) {
		...
		this.renderBoss((EntityEarthBoss)entity, par2, par3, par4, par5, par6);
	}
}