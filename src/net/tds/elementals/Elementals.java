...
import net.tds.elementals.packet.PacketHandler;
...
@NetworkMod(clientSideRequired = true, serverSideRequired = true, channels = {"ELEMENTALS"}, packetHandler = PacketHandler.class)
public class Elementals {
	...
	public void getModInfo(ModMetadata meta) {
		...
		meta.url = "http://www.darkhax.net/modjam.html";
	}
}